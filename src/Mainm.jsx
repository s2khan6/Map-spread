  ...
  return (
    <div className="flex-1 px-10 py-8 bg-blue-50 rounded-l-xl overflow-auto">
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <div className="w-28 h-10 bg-green-500 rounded-full flex items-center justify-center text-white font-bold">
          Фильтр
        </div>
      </div>
      ...
      <div className="bg-white px-6 py-8 rounded-2xl shadow-lg w-full max-w-[1200px] mx-auto min-h-[500px]">
        ...
        <div className="flex justify-between mb-6">
          <div className="w-24 h-6 bg-gray-400 rounded flex items-center justify-center text-white font-bold">
            SDP-242
          </div>
          <div className="w-24 h-6 bg-gray-400 rounded flex items-center justify-center text-white font-bold">
            Группа 5
          </div>
          <div className="w-40 h-6 bg-gray-400 rounded mx-auto flex items-center justify-center text-white font-bold">
            Количество{" "}
          </div>
          <div className="w-28 h-6 bg-gray-400 rounded flex items-center justify-center text-white font-bold">
            Присутствие
          </div>
        </div>
